...
Item {
    ...
    Item {
        ...
        Row {
            ...
            Item { width: parent.width; height: 1; visible: false }
    ...
    Item {
        ...
        // Empty State Text (Faded) - RESTORED
        Column {
            visible: NotificationState.history.count === 0
                ...
                Column {
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            font.pixelSize: 12; font.family: "JetBrainsMono Nerd Font"; color: PanelColors.textDim
                        }
                    }
